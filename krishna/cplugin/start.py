...
import config
# from krishna import app
from krishna.misc import _boot_
from krishna.plugins.sudo.sudoers import sudoers_list
from krishna.utils.database import get_served_chats, get_served_users, get_sudoers
from krishna.utils import bot_sys_stats
...
from krishna.utils.decorators.language import LanguageStart
from krishna.utils.formatters import get_readable_time
from krishna.utils.inline import help_pannel, private_panel, start_panel
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        [
            InlineKeyboardButton(text=_["time_pass"], url="https://t.me/bots_update_all"),
