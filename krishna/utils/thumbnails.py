...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("krishna/assets/font2.ttf", 30)
    font = ImageFont.truetype("krishna/assets/font.ttf", 30)
    title_font = ImageFont.truetype("krishna/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("krishna/assets/play_icons.png")
